...
export const InvoiceLayout = () => {
    ...
    const clientSelect = GenerateSelect("ri-building-line", "client", [
        ...
        { value: "c1", label: "Tech Solutions S.A." },
        { value: "c2", label: "Studio Design Limitada" }
    ])
    
    // Usamos flex para inputs de fecha
    const dateIssued = GenerateInput("ri-calendar-check-line", "Emisión", "date", "date_issued")
    const dateDue = GenerateInput("ri-calendar-event-line", "Vencimiento", "date", "date_due")

    // --- Modal de Previsualización (Estilo Hoja A4) ---
    const previewModal = `
        ...
        <div class="bg-gray-100 w-full h-full md:h-[90vh] md:w-[800px] md:rounded-xl relative z-10 flex flex-col overflow-hidden transform scale-95 transition-transform duration-300" id="preview-content">
                ...
                <div class="bg-white shadow-2xl min-h-[800px] p-8 md:p-12 mx-auto max-w-2xl" id="invoice-paper">
                    ...
                    <div class="flex justify-between items-start border-b-2 border-gray-100 pb-8 mb-8">
                        <div>
                            ...
                            <div class="text-gray-500 font-mono text-sm"># DRAFT-001</div>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-8 mb-8">
                        <div>
                            ...
                            <div class="text-gray-500 text-sm mt-1">Dirección del cliente...</div>
                        </div>
                        <div class="text-right">
                    ...
                    <table class="w-full mb-8">
                        ...
                        <tbody id="paper-items-body" class="text-sm text-gray-700 divide-y divide-gray-100">
                            <!-- Items inyectados -->
                        </tbody>
                    </table>
            ...
            <div class="bg-white p-4 border-t border-gray-200 flex justify-end gap-3 shrink-0">
                ...
                <button id="btn-confirm-invoice" class="px-6 py-2.5 rounded-lg bg-green-600 text-white font-medium hover:bg-green-700 shadow-lg shadow-green-500/20 transition-all flex items-center gap-2">
                    <i class="ri-check-double-line"></i> Confirmar y Emitir
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="layout-wrapper flex min-h-screen bg-gray-50">
        ...
        <main class="main-content flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center shrink-0 z-20">
                <div class="flex items-center gap-4">
                    ...
                    <div class="bg-gray-100 p-1 rounded-lg flex text-sm font-medium">
                        <button id="btn-mode-invoice" class="px-4 py-1.5 rounded-md bg-white text-blue-600 shadow-sm transition-all">Factura</button>
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-8">
                <div class="max-w-5xl mx-auto space-y-6">
                    ...
                    <!-- Card 2: Items del Documento -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <h2 class="text-sm font-bold text-gray-400 uppercase tracking-wide">Conceptos / Productos</h2>
